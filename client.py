...
medium = FilesystemProtocol(action_file_path="/scratch/gpfs/TSILVER/kp0374/neurogym-agent/proxy/actions", observation_file_path="/scratch/gpfs/TSILVER/kp0374/neurogym-agent/proxy/observations", timeout=99999)
