...
# ngllib keeps its heavy imports lazy, so the package import is cheap here
# (the spike venv this once file-loaded around no longer exists).
from ngllib.simulator.camera import projection_camera  # noqa: E402
from ngllib.simulator.colors import segment_color  # noqa: E402
